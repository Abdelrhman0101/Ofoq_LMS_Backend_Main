...
try {
    echo "🔄 Testing Arabic certificate generation...\n";
    ...
    // Save the PDF
    $outputPath = 'test_arabic_certificate_output.pdf';
    $pdf->save($outputPath);
    ...
    // Try to render the HTML to see what we're generating
    echo "\n📝 Rendering HTML preview...\n";
    $html = view('certificates.course_certificate_simple', $certificateData)->render();
    file_put_contents('test_arabic_certificate_preview.html', $html);
    echo "📄 HTML preview saved as: test_arabic_certificate_preview.html\n";
    
    echo "\n🎯 Arabic certificate test completed!\n";
